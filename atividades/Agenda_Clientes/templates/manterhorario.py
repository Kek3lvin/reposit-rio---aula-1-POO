...
class ManterHorarioUI:
    ...
    def inserir(): # CONTINUAR PASSO 5.2 - SLIDE
clientes
...
data
= st.text_input("Informe a data e horário do serviço",
datetime.now().strftime("%d/%m/%Y %H:%M"))
confirmado

= st.checkbox("Confirmado")

cliente

= st.selectbox("Informe o cliente", clientes, index

= None)

servico

= st.selectbox("Informe o serviço", servicos, index
...
if cliente != None: id_cliente

= cliente.get_id()

if servico != None: id_servico
